...
const Navbar=()=> {
    ...
    const GetName = async() => {
        ...
        let res= await fetch('https://sics-9hq7p.ondigitalocean.app/account/hello', options);
        if(res.status===200) {
       ...
       let response=await fetch('https://sics-9hq7p.ondigitalocean.app/tickets/stats', Ticketoptions)
