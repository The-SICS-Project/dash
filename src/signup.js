...
function Signup(props) {
    ...
    const onSubmit = async data => {
        ...
        let res = await fetch('https://sics-backend.azurewebsites.net/account/signup', options);
        ...
        if(res.status===200) {
            ...
            try {
                ...
                const res= await fetch('https://sics-backend.azurewebsites.net/account/segment', options)
console.log(res.status)
                ...
                if( res.status===205)
                {
                    ...
                    fetch('https://sics-backend.azurewebsites.net/account/signup', options)
