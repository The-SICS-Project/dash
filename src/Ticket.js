...
function Ticket() {
    ...
    const onSubmit = async data => {
        ...
        formdata.append("picture",data.images[0])
...
console.log(did_token);
      ...
      let res= await fetch('https://sics-backend.azurewebsites.net/tickets/create', options);
      console.log(res)
        if(res.status==200){
            swal({
                title: "Thank you!",
    ...
    <div className="ticketform">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <input className="fileselect" id="file" type="file" multiple {...register("images")}/>
